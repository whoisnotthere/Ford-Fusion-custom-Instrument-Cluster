...
import "Left_Wheel_Components/"

Item {
    id: left_Cards_Wheel_Item
    width: 660
    height: 720
    ...
    function get_Card_From_Settings() {
        let card_Value = IC_PREFERENCES.get_Card_Left;
        return card_Value;
    }

    function save_Card_To_Settings(new_Card_Value) {
        IC_PREFERENCES.set_Card_Left(new_Card_Value);
    }
    ...
    PathView {
        ...
        delegate: Left_Wheel_Item_Delegate {}
        model: Left_Wheel_Model {}
        ...
        anchors.topMargin: left_Cards_Wheel_Item.height / 2
